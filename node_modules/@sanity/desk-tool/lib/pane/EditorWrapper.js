...
class EditorWrapper extends _react2.default.Component {
  ...
  setup(documentId) {
    ...
    var _checkoutPair = (0, _formBuilder.checkoutPair)({ publishedId, draftId });

    const published = _checkoutPair.published,
    ...
    this.subscription = (0, _rxjs.merge)(published$.pipe((0, _operators.map)(event => _extends({}, event, { version: 'published' }))), draft$.pipe((0, _operators.map)(event => _extends({}, event, { version: 'draft' })))).subscribe(event => {
