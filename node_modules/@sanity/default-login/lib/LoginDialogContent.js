...
var _LoginDialogContent = require('./styles/LoginDialogContent.css');
...
class LoginDialogContent extends _react2.default.Component {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.handleLoginButtonClicked = (provider, event) => {
  ...
  render() {
    ...
    return _react2.default.createElement(
      'div',
      { className: _LoginDialogContent2.default.root },
      _react2.default.createElement(
        'div',
        { className: _LoginDialogContent2.default.inner },
        SanityLogo && _react2.default.createElement(
          'div',
          { className: _LoginDialogContent2.default.sanityLogo },
          _react2.default.createElement(SanityLogo, null)
        ),
        _react2.default.createElement(
          'div',
          { className: _LoginDialogContent2.default.branding },
          _react2.default.createElement(
            'h1',
            { className: _brandLogo2.default ? _LoginDialogContent2.default.projectNameHidden : _LoginDialogContent2.default.projectName },
            projectName
          ),
          _brandLogo2.default && _react2.default.createElement(
            'div',
            { className: _LoginDialogContent2.default.brandLogoContainer },
            _react2.default.createElement(_brandLogo2.default, { projectName: projectName })
          )
        ),
        _react2.default.createElement(
          'h2',
          { className: _LoginDialogContent2.default.title },
          title
        ),
        description && _react2.default.createElement(
          'div',
          { className: _LoginDialogContent2.default.description },
          description
        ),
        _react2.default.createElement(
          'ul',
          { className: _LoginDialogContent2.default.providers },
          providers.map(provider => {
            const ProviderLogo = getProviderLogo(provider);
            const onLoginClick = this.handleLoginButtonClicked.bind(this, provider);
            return _react2.default.createElement(
              'li',
              { key: provider.name, className: _LoginDialogContent2.default.provider },
              _react2.default.createElement(
                'button',
                { type: 'button', onClick: onLoginClick, className: _LoginDialogContent2.default.providerButton },
                _react2.default.createElement(
                  'span',
                  { className: _LoginDialogContent2.default.providerLogo },
                  _react2.default.createElement(ProviderLogo, null)
                ),
                _react2.default.createElement(
                  'span',
                  { className: _LoginDialogContent2.default.providerName },
                  provider.title
                )
              )
            );
...
LoginDialogContent.defaultProps = {
  description: null,
  title: null,
  providers: null,
