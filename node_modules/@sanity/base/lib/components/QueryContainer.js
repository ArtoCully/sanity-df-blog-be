...
class QueryContainer extends _react2.default.Component {
  ...
  subscribe(query, params) {
    this.unsubscribe();
    this._subscription = _document2.default.query(query, params).pipe((0, _operators.filter)(event => event.type === 'snapshot' || RESPOND_TO_TRANSITIONS.includes(event.transition))).subscribe(this);
  }
