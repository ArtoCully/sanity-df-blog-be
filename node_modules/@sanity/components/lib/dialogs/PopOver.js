...
class PopOver extends _react2.default.PureComponent {
  constructor(...args) {
    var _temp;

    return _temp = super(...args), this.createActionButton = (action, i) => {
        ...
        _react2.default.createElement(
          ...
          actions.length > 0 && _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              { align: 'end', secondary: primary.map(this.createActionButton) },
