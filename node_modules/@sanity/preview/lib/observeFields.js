...
const getGlobalEvents = () => {
  if (!_globalListener) {
    const allEvents$ = (0, _rxjs.from)(_client2.default.listen('*[!(_id in path("_.**"))]', {}, { events: ['welcome', 'mutation'], includeResult: false })).pipe((0, _operators.share)());
...
function fetchAllDocumentPaths(selections /*: Selection[]*/) {
  ...
  return _client2.default.observable.fetch((0, _optimizeQuery.toGradientQuery)(combinedSelections)).pipe((0, _operators.map)(result => (0, _optimizeQuery.reassemble)(result, combinedSelections)));
}
...
function cachedObserveFields(id /*: Id*/, fields /*: FieldName[]*/) {
  ...
  (0, _operators.filter)(snapshots => (0, _isUniqueBy2.default)(snapshots, snapshot => snapshot._rev)),
  ...
  (0, _operators.distinctUntilChanged)((0, _hasEqualFields2.default)(fields)));
}
