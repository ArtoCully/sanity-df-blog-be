...
function uploadImage(file /*: File*/) /*: ObservableI<UploadEvent>*/ {
  const upload$ = (0, _assets.uploadImageAsset)(file).pipe((0, _operators.filter)(event => event.stage !== 'download'), (0, _operators.map)(event => _extends({}, event, {
  ...
  const setPreviewUrl$ = (0, _readExif2.default)(file).pipe((0, _operators.mergeMap)((exifData /*: Exif*/) => (0, _rotateImage2.default)(file, exifData.orientation || _orient.DEFAULT_ORIENTATION)), (0, _operators.catchError)(error => {
