...
function readExif(file /*: File*/) {
  return (0, _rxjs.from)(readFileAsArrayBuffer(file, EXIF_BUFFER_LENGTH)).pipe((0, _operators.map)(buf => (0, _exifComponent2.default)(buf)), (0, _operators.catchError)(error => {
