...
function uploadSanityAsset(assetType, file) {
  return (0, _rxjs.from)(hashFile(file)).pipe((0, _operators.catchError)(error =>
  ...
  (0, _rxjs.of)(null)), (0, _operators.mergeMap)(hash => hash ? fetchExisting(`sanity.${assetType}Asset`, hash) : (0, _rxjs.of)(null)), (0, _operators.mergeMap)(existing => {
    ...
    return _client2.default.observable.assets.upload(assetType, file).pipe((0, _operators.map)(event => event.type === 'response' ? {
