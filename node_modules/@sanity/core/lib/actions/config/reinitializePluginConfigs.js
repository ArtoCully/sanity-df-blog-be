...
exports.tryInitializePluginConfigs = undefined;

let reinitializePluginConfigs = (() => {
  var _ref = _asyncToGenerator(function* (options, flags = {}) {
    ...
    function hasLocalConfig(plugin) {
      return (0, _pluginChecksumManifest.localConfigExists)(workDir, plugin.name).then(configDeployed => Object.assign({}, plugin, { configDeployed }));
    }
  ...
  return function reinitializePluginConfigs(_x) {
    return _ref.apply(this, arguments);
  };
})();

let tryInitializePluginConfigs = exports.tryInitializePluginConfigs = (() => {
  var _ref2 = _asyncToGenerator(function* (options, flags = {}) {
    try {
      ...
      const manifest = yield _fsExtra2.default.readJson(_path2.default.join(options.workDir, 'package.json')).catch(function () {
        return {};
      });
  ...
  return function tryInitializePluginConfigs(_x2) {
...
function getPluginConfigChecksum(plugin) {
  return (0, _generateConfigChecksum2.default)(getPluginConfigPath(plugin)).then(configChecksum => Object.assign({}, plugin, { configChecksum }));
}